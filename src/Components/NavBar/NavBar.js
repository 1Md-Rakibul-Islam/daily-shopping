...
const NavBar = () => {
    ...
    return (
        <div className="navbar flex justify-between bg-base-200">
            <div className="">
                <Link className="normal-case text-xl">Daily Shopping</Link>
            </div>
            ...
            <ul tabIndex={0} className="hidden md:flex gap-5 ">
                ...
                <li className='hover:text-primary'><Link to="/cart" >Products</Link></li>
                <li className='hover:text-primary'><Link>Logout</Link></li>
            </ul>
